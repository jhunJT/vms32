        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-body h-45">
                            <h4 class="card-title mb-2">Pie Chart</h4>
                            <div class="mb-2">
                                <canvas id="piestat1" height="200"></canvas>
                            </div>
                        </div>
                        {{-- <div class="card card-body h-45">
                            <h4 class="card-title">Pie Chart</h4>
                            <div class="mb-2">
                                <canvas id="piestat2" height="200"></canvas>
                            </div>
                        </div> --}}
...
var totalCV = "{{ ($totalCV) }}";
var totalRV = "{{ ($totalRV) }}";
console.log(((totalRV-totalCV)/totalRV)*100,(totalCV/totalRV)*100);
</script> =
