                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-1 ">
                                            <div class="input-group gap-2">
                                                ...
                                                <input type="hidden" class="form-control" id="houseleaderSelectName"  name="houseleaderSelectName"  >
                                                <input type="text" class="form-control w-s" id="setPurok" placeholder="Purok" name="setPurok" size="4" >
...
<script>
    ...
    var encoderDataBrgy = "{{ route('encoder.fetchBrgy') }}";
