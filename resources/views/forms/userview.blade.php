...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="tbUser" class="table table-striped table-bordered tbUserView" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
    ...
    <script>
        var dashboardAdminView = "{{ route('usermanagement.dashboard') }}";
        var dashboardAdminEdit = "{{ route("usermanagement.edit","")}}";
        var dashboardAdminStore = "{{ route('usermanagement.store') }}";
        var dashboardAdminDelete = "{{ route("usermanagement.delete","")}}";
    </script>
    <script src="{{ asset('assets/auth/js/userview.js') }}"></script>
